...
<a href="{{ route('player.profile', $player->id) }}"
    ...
    <!-- Player Image -->
    <div
        class="relative w-16 h-16 md:w-20 md:h-20 rounded-full border-2 md:border-4 border-white shadow-lg overflow-hidden bg-gray-800 group-hover:border-yellow-400 transition-colors">
        @if($player->foto_url)
        ...
        <!-- Rating Badge -->
        <div
            class="absolute bottom-0 right-0 bg-yellow-500 text-black text-[10px] md:text-xs font-bold px-1.5 py-0.5 rounded-full border border-white leading-none">
    ...
    <div class="mt-2 text-center">
        ...
        <p class="text-[10px] md:text-xs text-gray-300 mt-1 shadow-black drop-shadow-md font-medium">
