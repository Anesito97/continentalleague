<div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
    ...
    {{-- Panel Lateral de Navegación Admin (Visible y apilado en Móvil) --}}
    <nav class="col-span-1 card p-4 space-y-2 hover:transform-none">
        ...
        <a href="{{ route('admin.teams') }}"
            class="admin-nav-item w-full text-left p-3 rounded-lg flex items-center text-sm font-medium transition duration-300
        ...
        <a href="{{ route('admin.matches') }}"
            ...
            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">...</svg> Gestión de Partidos
        </a>
        
        {{-- FINALIZAR PARTIDO (Estética mejorada) --}}
    ...
    {{-- Área de Contenido Admin (Ocupa el resto del espacio en escritorio) --}}
    <div class="col-span-1 lg:col-span-3">
        ...
        {{-- INCLUSIÓN DINÁMICA DE CONTENIDO (Se muestra debajo de la barra lateral en móvil) --}}
